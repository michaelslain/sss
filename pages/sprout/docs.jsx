        ...
        <>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.page}>
                    ...
                    <Text>
                        Welcome to Sprout, a programming language that is
                        completely readable by any english speaker. Let's start
                        with a <b>Hello World</b> example (hello world is the
                        first program any programmer writes):
                    </Text>
                    <Code>say "hello world".</Code>
                    <Text>
                        As you have probably guessed, this just makes the
                        program say "hello world." The <C>say</C> keyword makes
                        the program say whatever is after it.
                    </Text>
                    <Text>
                        It's important to note that all text needs to be put in{' '}
                        <C>""</C>, and all numbers can just be stated normally
                        like this: <C>420</C>.
                    </Text>
                    <Text>
                        There's one more data type that can be used besides text
                        and numbers which is called a boolean. A boolean is just{' '}
                    ...
                    <Text>
                        Here's an example of how to use a math operator:
                    </Text>
                    ...
                    <Text>
                        ...
                        <C>"hello"</C> which you can use later in your code. So
                        the line <C>say message</C> makes the program say
                        "hello".
                    </Text>
                    <Text>
                    ...
                    <Text>
                        A function is just a chunk of code that can be assigned
                        a name, and then used later. Here is an example:
                    </Text>
                    <Code>
                        {
                            'let thisFunction do:\n  say "bruh".\n  say "chicken".\n  stop.'
                    ...
                    <Text>
                        ...
                        know when the code block for the function shoud end. To
                        run the block of code, you can do this:
                    </Text>
                    <Code>{'run thisFunction.'}</Code>
                    <Text>
                        And you can run it as many times as you want to in your
                        code like this:
                    </Text>
                    <Code>
                        {
                    ...
                    <Text>
                        ...
                        essentially just variables that you can put in the
                        function when you run it. To demonstrate, let's look at
                        this example:
                    </Text>
                    <Code>
                        {
                    ...
                    <Text>
                        The first 3 lines just create the function. Notice how
                        the 2nd line uses the variable <C>message</C> even
                        though we never made it. This is because when we run the
                        function, we create it. <C>message</C> stops existing
                        once the function stops running.
                    </Text>
                    <Text>
                    ...
                    <Text>
                        An if statement is a block of code than only runs if
                        some condition is <C>true</C>. For example:
                    </Text>
                    <Code>
                        {
                    ...
                    <Text>
                        Else statements are similar to if statements, except
                        else statements run if a condition is true and if a
                        previous if statement's condition is false. For example:
                    </Text>
                    <Code>
                        {
